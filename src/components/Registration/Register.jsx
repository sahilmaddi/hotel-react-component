...
>
  ...
  <p ref={errRef} className={errMsg ? "errmsg" : "offscreen"} aria-live="assertive">{errMsg}</p>
    ...
    <div className="form-group mt-3">
      ...
      <Row className="mb-1">      
      <Form.Group as={Col} >
          <Form.Label>Name :</Form.Label>&emsp;&emsp;&emsp;
         <input type="text"
         required
...
<Row className="mb-2"> 
              <Form.Group as={Col} >
                <Form.Label htmlFor="Username">Username :</Form.Label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
          &ensp;
...
<Row className="mb-3">      
      <Form.Group as={Col} >
          <Form.Label>Password :</Form.Label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
          &ensp;
...
<br />
      ...
      <Row className="mb-4"> 
              <Form.Group as={Col} >
                <Form.Label htmlFor="email">Email :</Form.Label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
          &ensp;
    ...
    <Row className="mb-5"> 
              <Form.Group as={Col} >
                <Form.Label htmlFor="age">Age :</Form.Label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
          &ensp;&emsp;
...
<input type="radio" value="Female" name="gender" /> other
              ...
              <Row className="mb-3"> 
              <Form.Group as={Col} >
                <Form.Label htmlFor="phone number :">Phone Number :</Form.Label>&emsp;&emsp;&emsp;&emsp;&emsp;
          &ensp;
