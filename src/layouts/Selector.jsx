...
<div className="sc-fzpkqZ dQsCrs">
    <center className="m-0 top-1/4">
    {/* <h2 font-size="20px,24px,28px" font-weight="bold" 
    className="sc-fzpjYC bb">Latest reviews. Lowest prices.</h2>
    
    <p color="#2C2C2C" font-size="15px" className="sc-AxirZ jBbBTX">
    compares prices from 200+ booking sites to help you find 
    the lowest price on the right hotel for you.
    </p> */}
    ...
    <div className="sc-fznAgC dOPEPt">
        ...
        <path d="M72.042,52.541c-10.729,0-19.459,8.729-19.459,19.459s8.729,19.459,19.459,19.459S91.5,82.729,91.5,72  S82.771,52.541,72.042,52.541z M72.042,85.459c-7.421,0-13.459-6.037-13.459-13.459c0-7.421,6.038-13.459,13.459-13.459  S85.5,64.579,85.5,72C85.5,79.422,79.462,85.459,72.042,85.459z"></path>
        </svg> 
        </div>
        <div class="sc-fznLPX cSRaiB">
            <svg stroke="currentColor" fill="currentColor" 
        ...
        <div className="DateRangePickerInput DateRangePickerInput_1 DateRangePickerInput__withBorder DateRangePickerInput__withBorder_2 DateRangePickerInput__showClearDates DateRangePickerInput__showClearDates_3">
            ...
            <input className="DateInput_input DateInput_input_1 DateInput_input__small DateInput_input__small_2" aria-label="Start Date" type="text" id="startDateId-id-home" name="startDateId-id-home" 
            placeholder="Start Date" autocomplete="off" 
            // onClick={<DateRangePicker/>} 
            aria-describedby="DateInput__screen-reader-message-startDateId-id-home" />
                ...
                DateInput_input__small_2" aria-label="End Date" type="text" id="endDateId-id-home" name="endDateId-id-home" placeholder="End Date" autocomplete="off" aria-describedby="DateInput__screen-reader-message-endDateId-id-home" /><p class="DateInput_screenReaderMessage DateInput_screenReaderMessage_1" id="DateInput__screen-reader-message-endDateId-id-home">
                    ...
                    className="DateRangePickerInput_clearDates DateRangePickerInput_clearDates_1 DateRangePickerInput_clearDates__small DateRangePickerInput_clearDates__small_2 DateRangePickerInput_clearDates_default DateRangePickerInput_clearDates_default_3 DateRangePickerInput_clearDates__hide DateRangePickerInput_clearDates__hide_4">
                        {/* <svg class="DateRangePickerInput_clearDates_svg DateRangePickerInput_clearDates_svg_1 DateRangePickerInput_clearDates_svg__small DateRangePickerInput_clearDates_svg__small_2" focusable="false" viewBox="0 0 12 12"> */}
                ...
                </div></div></div></div></div><div class="sc-fznLPX cSRaiB"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" class="user-friends" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M192 256c61.9 0 112-50.1 112-112S253.9 32 192 32 80 82.1 80 144s50.1 112 112 112zm76.8 32h-8.3c-20.8 10-43.9 16-68.5 16s-47.6-6-68.5-16h-8.3C51.6 288 0 339.6 0 403.2V432c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48v-28.8c0-63.6-51.6-115.2-115.2-115.2zM480 256c53 0 96-43 96-96s-43-96-96-96-96 43-96 96 43 96 96 96zm48 32h-3.8c-13.9 4.8-28.6 8-44.2 8s-30.3-3.2-44.2-8H432c-20.4 0-39.2 5.9-55.7 15.4 24.4 26.3 39.7 61.2 39.7 99.8v38.4c0 2.2-.5 4.3-.6 6.4H592c26.5 0 48-21.5 48-48 0-61.9-50.1-112-112-112z"></path></svg><div class="sc-fzoydu ctZjfV view_with__popup room_guest "><div class="popup_handler"><button type="button" class="ant-btn ant-btn-default" ant-click-animating-without-extra-node="true"><span>Room </span><span>-</span><span>Guest</span></button></div><div class="sc-fzqMAW fLHwCp popup_container"></div></div></div><button type="submit" class="ant-btn ant-btn-primary ant-btn-lg">
                <span>Find Hotels</span>
            </button>
            </div>
            </center>
            <div class="sc-fznMnq biVOqy glide__bullets" data-glide-el="controls[nav]"><button class="sc-fzoant hXtGXC glide__bullet" data-glide-dir="=0"></button><button class="sc-fzoant hXtGXC glide__bullet" data-glide-dir="=1"></button><button class="sc-fzoant hXtGXC glide__bullet glide__bullet--active" data-glide-dir="=2"></button></div>
            </div>
