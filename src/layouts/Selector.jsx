...
<div className="sc-fzpkqZ dQsCrs">
    <h2 color="#2C2C2C" font-size="20px,24px,28px" font-weight="bold" 
    ...
    <div className="sc-fznAgC dOPEPt">
        <div className="sc-fznLPX cSRaiB">
            ...
            <path d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z"></path></svg><div class="map_autocomplete">
        ...
        <path d="M72.042,52.541c-10.729,0-19.459,8.729-19.459,19.459s8.729,19.459,19.459,19.459S91.5,82.729,91.5,72  S82.771,52.541,72.042,52.541z M72.042,85.459c-7.421,0-13.459-6.037-13.459-13.459c0-7.421,6.038-13.459,13.459-13.459  S85.5,64.579,85.5,72C85.5,79.422,79.462,85.459,72.042,85.459z"></path></svg></div><div class="sc-fznLPX cSRaiB">
            <svg stroke="currentColor" fill="currentColor" 
        ...
        <div className="DateRangePickerInput DateRangePickerInput_1 DateRangePickerInput__withBorder DateRangePickerInput__withBorder_2 DateRangePickerInput__showClearDates DateRangePickerInput__showClearDates_3">
            ...
            <input className="DateInput_input DateInput_input_1 DateInput_input__small DateInput_input__small_2" aria-label="Start Date" type="text" id="startDateId-id-home" name="startDateId-id-home" placeholder="Start Date" autocomplete="off" aria-describedby="DateInput__screen-reader-message-startDateId-id-home" value=""/>
                ...
                DateInput_input__small_2" aria-label="End Date" type="text" id="endDateId-id-home" name="endDateId-id-home" placeholder="End Date" autocomplete="off" aria-describedby="DateInput__screen-reader-message-endDateId-id-home" value=""/><p class="DateInput_screenReaderMessage DateInput_screenReaderMessage_1" id="DateInput__screen-reader-message-endDateId-id-home">
